              ...
              {streams.map(s => (
                ...
                <tr key={s.correlationId}>
                  ...
                  <td className="space-x-2">
                    <button className="btn btn-xs" disabled={loadingId===s.correlationId} onClick={async()=>{
                    ...
                    <button className="btn btn-xs btn-outline" disabled={loadingId===s.correlationId} onClick={async()=>{
                      setLoadingId(s.correlationId); setError(null); setMessage(null);
                  ...
                  <tr>
                    <td colSpan={5}>
                      <div className="flex items-center justify-between mb-1">
                        ...
                        <a className="btn btn-xs" href={`${getBaseUrl()}/executions/${params.id}/tool-streams/${s.correlationId}/export?format=json&compress=0`} target="_blank" rel="noreferrer">下载JSON</a>
                      </div>
